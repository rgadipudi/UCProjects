	 ...
	 void parse(String strLine) throws IOException 
		{
			...
			{
				FileWriter writer = new FileWriter(folderName+"/2.csv", true);
				// write data in to report file
				writer.append(strLine+"\n");
				writer.flush();
			    writer.close();
			...
			{		
				FileWriter writer = new FileWriter(folderName+"/3.csv", true);
				// write data in to report file
				writer.append(strLine+"\n");
				writer.flush();
			    writer.close();
			...
			{
				FileWriter writer = new FileWriter(folderName+"/4.csv", true);
				// write data in to report file
				writer.append(strLine+"\n");
				writer.flush();
			    writer.close();
			...
			{
				FileWriter writer = new FileWriter(folderName+"/5.csv", true);
				// write data in to report file
				writer.append(strLine+"\n");
				writer.flush();
			    writer.close();
			...
			{
				FileWriter writer = new FileWriter(folderName+"/6.csv", true);
				// write data in to report file
				writer.append(strLine+"\n");
				writer.flush();
			    writer.close();
